...
public class TestDataClassGenerator {
    ...
    private static String FILE_SEPARATOR_IN_DECLARATION;
    ...
    static {
        FILE_SEPARATOR_IN_DECLARATION = "\" + File.separator + \"";
...
//        }
    ...
    private static String fileNameFromPackageName(String packageName) {
        String name = packageName.replace(".", File.separator);
        return rootSrcDirectoryName + File.separator + name + File.separator;
    }
    ...
    private void writePathVariable(BufferedWriter writer) throws IOException {
        ...
        relativePath = relativePath.replace("\\", FILE_SEPARATOR_IN_DECLARATION);
