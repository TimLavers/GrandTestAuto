...
import org.grandtestauto.settings.LastClass;
 ...
 * @author Tim Lavers
 */
public class LastClassTest extends PackageSpecTest {

    public boolean keyTest() {
        init();
        Assert.aequals(LastClass.LAST_CLASS, new LastClass().key());
        return true;
    }
    ...
    public boolean buildFromTest() {
        ...
        properties.put(LastClass.LAST_CLASS, "Lion");
        ip = new LastClass();
        ip.buildFrom(properties);
        ip.addTo(settings);
    ...
    public boolean valueInUserExplanationTest() {
        ...
        properties.put(LastClass.LAST_CLASS, "Aardwolf");
        ip = new LastClass();
        ip.buildFrom(properties);
        ip.addTo(settings);
